...
function theme.at_screen_connect(s)
    ...
    -- Tags
    if s.index == 2 then
        awful.tag(awful.util.tagnames, s, awful.util.layouts_screen2)
    elseif s.index == 3 then
        awful.tag(awful.util.tagnames, s, awful.util.layouts_screen3)
    else
        awful.tag(awful.util.tagnames, s, awful.util.layouts_screen1)
    end
